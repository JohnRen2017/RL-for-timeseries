...
class Environ:
    def __init__(self, data=None, max_iteration=None, lookback=3, genlength=24 * 30):
        if data is not None:
            ...
            self.data = self.gendata(genlength)
        ...
        if os.path.exists(os.path.join(os.getcwd(), "true.txt")):
            os.remove(os.path.join(os.getcwd(), "true.txt"))
        if os.path.exists(os.path.join(os.getcwd(), "pred.txt")):
            os.remove(os.path.join(os.getcwd(), "pred.txt"))
